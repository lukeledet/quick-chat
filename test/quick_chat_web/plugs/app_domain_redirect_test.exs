defmodule QuickChatWeb.AppDomainRedirectTest do
  @moduledoc """
  Tests for QuickChatWeb.AppDomainRedirect
  """
  use QuickChatWeb.ConnCase, async: true
  alias QuickChatWeb.AppDomainRedirect
  ...
  test "redirects from bad hostname when active" do
    port = get_in(Application.get_env(:quick_chat, QuickChatWeb.Endpoint), [:http, :port])
